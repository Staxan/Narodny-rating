  ...
  return (
    <div className="presentation-page">
      <header className="presentation-nav">
        ...
        <nav><a href="#about">О проекте</a><a href="#principles">Принципы</a><a href="#projects">Мои проекты</a></nav>
      ...
      <main>
        ...
        {unlocked && <section className="full-presentation anim" id="full-presentation"><div className="wrap"><div className="unlock-badge">✦ Полная презентация доступна</div><div className="presentation-actions"><Link className="btn" href="/presentation/expanded">Открыть расширенную презентацию →</Link></div><div className="section-kicker">03 · Расширенная концепция</div><div className="section-heading"><h2>От рейтинга депутатов<br /><em>к системе для всех уровней</em></h2><p>Это общий каркас проекта. Детальная концепция, архитектура и дорожная карта будут добавлены после утверждения материалов.</p></div><div className="roadmap"><div className="road-step active"><span>01</span><h3>Депутаты</h3><p>Государственный, региональный и муниципальный уровни.</p></div><div className="road-step"><span>02</span><h3>Чиновники</h3><p>Постепенное расширение на местные и региональные структуры.</p></div><div className="road-step"><span>03</span><h3>Инициативы</h3><p>Предложения граждан и общественное голосование на следующих этапах.</p></div><div className="road-step"><span>04</span><h3>Автономность</h3><p>Распределённая инфраструктура и агенты с ограниченными задачами.</p></div></div><div id="projects" className="projects-placeholder"><div><span className="section-kicker">Мои проекты</span><h3>Экосистема идей и технологий</h3><p>Здесь появятся проекты, которые развиваются рядом с Народным рейтингом.</p></div><div className="project-card"><span>Проект · в разработке</span><strong>Киберсоциализм</strong><small>Концепция общественной и технологической системы</small></div><div className="project-card muted"><span>Скоро</span><strong>Новый проект</strong><small>Карточка будет добавлена позже</small></div></div></div></section>}
