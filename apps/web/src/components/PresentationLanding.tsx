  ...
  return (
    <div className="presentation-page">
      <header className="presentation-nav">
        ...
        <Link className="btn" href="/demo">Посмотреть демо <span>↗</span></Link>
      </header>
